...
if (rain)
{
	var camX = camera_get_view_x(view);
	var camY = camera_get_view_y(view);
	part_emitter_region(global.persistentPartSystem, global.rainEmitter, camX - viewWidth * 0.75, camX + viewWidth + viewWidth * 0.75, camY - viewHeight, camY - viewHeight, ps_shape_rectangle, ps_distr_linear);
}